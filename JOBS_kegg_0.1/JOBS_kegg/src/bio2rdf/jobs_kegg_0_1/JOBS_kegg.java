...
/**
 * Job: JOBS_kegg Purpose: <br>
 * Description:  <br>
 * @author test@talend.com
 * @version 5.6.0.20141024_1545
 * @status 
 */
public class JOBS_kegg implements TalendJob {
	...
	private final String jobName = "JOBS_kegg";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(JOBS_kegg.this, new Object[] { e,
	...
	public static class row2Struct implements
		...
		final static byte[] commonByteArrayLock_BIO2RDF_JOBS_kegg = new byte[0];
		static byte[] commonByteArray_BIO2RDF_JOBS_kegg = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_BIO2RDF_JOBS_kegg.length) {
					if (length < 1024
							&& commonByteArray_BIO2RDF_JOBS_kegg.length == 0) {
						commonByteArray_BIO2RDF_JOBS_kegg = new byte[1024];
					} else {
						commonByteArray_BIO2RDF_JOBS_kegg = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_BIO2RDF_JOBS_kegg, 0, length);
				strReturn = new String(commonByteArray_BIO2RDF_JOBS_kegg, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_BIO2RDF_JOBS_kegg) {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				class Util_tLogRow_1 {
					...
					public String print(String[] row, int nbLine) {
						...
						// for(int i=0; i<row.length; i++){
						sb.append("| " + "namespace");
						for (int i = 0; i < titleWidth - "namespace".length()
								+ 1; i++)
							sb.append(" ");
						sb.append("| " + row[1]);
				...
				result_tFixedFlowInput_1
						.append("aHR0cDovL2JpbzJyZGYub3JnL2tlZ2dfdm9jYWJ1bGFyeTpQYXRod2F5O2tlZ2cKaHR0cDovL2Jp");
				result_tFixedFlowInput_1
						.append("bzJyZGYub3JnL2tlZ2dfdm9jYWJ1bGFyeTpNb2R1bGU7a2VnZwpodHRwOi8vYmlvMnJkZi5vcmcv");
				result_tFixedFlowInput_1
						.append("a2VnZ192b2NhYnVsYXJ5OlJlYWN0aW9uO2tlZ2cKaHR0cDovL2JpbzJyZGYub3JnL2tlZ2dfdm9j");
				result_tFixedFlowInput_1
						.append("YWJ1bGFyeTpSUGFpcjtrZWdnCmh0dHA6Ly9iaW8ycmRmLm9yZy9rZWdnX3ZvY2FidWxhcnk6UlBh");
				result_tFixedFlowInput_1.append("aXItUm9sZTtrZWdn");
				...
				for (int i_tFixedFlowInput_1 = 0; i_tFixedFlowInput_1 < 1; i_tFixedFlowInput_1++) {
					...
					while (fid_tFixedFlowInput_1.nextRecord()) {
						...
						if (1 < fid_tFixedFlowInput_1
							...
							row1.namespace = (colContent == null || colContent
									.length() == 0) ? null : colContent;
						} else {
						...
						if (row3.namespace != null) { //

							strBuffer_tLogRow_1.append(String
									.valueOf(row3.namespace));
						...
						if (row3.type != null) { //
							row_tLogRow_1[0] = String.valueOf(row3.type);

						} //

						if (row3.namespace != null) { //
							row_tLogRow_1[1] = String.valueOf(row3.namespace);
	...
	public static void main(String[] args) {
		final JOBS_kegg JOBS_keggClass = new JOBS_kegg();

		int exitCode = JOBS_keggClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = JOBS_kegg.class.getClassLoader()
					.getResourceAsStream(
							"bio2rdf/jobs_kegg_0_1/contexts/" + contextStr
									+ ".properties");
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : JOBS_kegg");
		}
...
/************************************************************************************************
 * 54302 characters generated by Talend Open Studio for Data Integration on the
 * July 14, 2016 7:57:00 EDT AM
 ************************************************************************************************/
