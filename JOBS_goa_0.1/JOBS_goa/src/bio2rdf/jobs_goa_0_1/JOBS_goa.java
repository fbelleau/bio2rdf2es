...
/**
 * Job: JOBS_goa Purpose: <br>
 * Description:  <br>
 * @author test@talend.com
 * @version 5.6.0.20141024_1545
 * @status 
 */
public class JOBS_goa implements TalendJob {
	...
	private final String jobName = "JOBS_goa";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(JOBS_goa.this, new Object[] { e,
	...
	public static class row2Struct implements
		...
		final static byte[] commonByteArrayLock_BIO2RDF_JOBS_goa = new byte[0];
		static byte[] commonByteArray_BIO2RDF_JOBS_goa = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_BIO2RDF_JOBS_goa.length) {
					if (length < 1024
							&& commonByteArray_BIO2RDF_JOBS_goa.length == 0) {
						commonByteArray_BIO2RDF_JOBS_goa = new byte[1024];
					} else {
						commonByteArray_BIO2RDF_JOBS_goa = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_BIO2RDF_JOBS_goa, 0, length);
				strReturn = new String(commonByteArray_BIO2RDF_JOBS_goa, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_BIO2RDF_JOBS_goa) {
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				result_tFixedFlowInput_1
						.append("aHR0cDovL2JpbzJyZGYub3JnL2dvYV92b2NhYnVsYXJ5OkdPLUFubm90YXRpb24=");
				...
				for (int i_tFixedFlowInput_1 = 0; i_tFixedFlowInput_1 < 1; i_tFixedFlowInput_1++) {
					...
					while (fid_tFixedFlowInput_1.nextRecord()) {
						...
						parentContextMap_tRunJob_2.put("limit", context.limit);

						parentContextMap_tRunJob_2.put("n", context.n);

						parentContextMap_tRunJob_2.put("index", context.index);

						parentContextMap_tRunJob_2.put("namespace",
								context.namespace);

						parentContextMap_tRunJob_2
								.put("limit1", context.limit1);
						...
						bio2rdf.describe_goa_2_jsonld_0_1.describe_goa_2_jsonld childJob_tRunJob_2 = new bio2rdf.describe_goa_2_jsonld_0_1.describe_goa_2_jsonld();
						// pass DataSources
	...
	public static void main(String[] args) {
		final JOBS_goa JOBS_goaClass = new JOBS_goa();

		int exitCode = JOBS_goaClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = JOBS_goa.class.getClassLoader()
					.getResourceAsStream(
							"bio2rdf/jobs_goa_0_1/contexts/" + contextStr
									+ ".properties");
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : JOBS_goa");
		}
...
/************************************************************************************************
 * 44434 characters generated by Talend Open Studio for Data Integration on the
