...
package bio2rdf.describe_goa_2_jsonld_0_1;
...
/**
 * Job: describe_goa_2_jsonld Purpose: <br>
 * Description:  <br>
 * @author test@talend.com
 * @version 5.6.0.20141024_1545
 * @status 
 */
public class describe_goa_2_jsonld implements TalendJob {
	...
	private final String jobName = "describe_goa_2_jsonld";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					describe_goa_2_jsonld.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(describe_goa_2_jsonld.this, new Object[] {
	...
	public static class out7Struct implements
		...
		final static byte[] commonByteArrayLock_BIO2RDF_describe_goa_2_jsonld = new byte[0];
		static byte[] commonByteArray_BIO2RDF_describe_goa_2_jsonld = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_BIO2RDF_describe_goa_2_jsonld.length) {
					if (length < 1024
							&& commonByteArray_BIO2RDF_describe_goa_2_jsonld.length == 0) {
						commonByteArray_BIO2RDF_describe_goa_2_jsonld = new byte[1024];
					} else {
						commonByteArray_BIO2RDF_describe_goa_2_jsonld = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_BIO2RDF_describe_goa_2_jsonld, 0,
						length);
				strReturn = new String(
						commonByteArray_BIO2RDF_describe_goa_2_jsonld, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_BIO2RDF_describe_goa_2_jsonld) {
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				URL_string_tSparqlSelectRequest_1 = "http://bio2rdf.org/sparql"
						...
						+ java.net.URLEncoder
								.encode("select distinct ?s  where {   ?s a ?t .    filter(?t = <"
										+ context.type
										+ ">) .  ?s <http://bio2rdf.org/goa_vocabulary:target> ?target .  ?target <http://bio2rdf.org/goa_vocabulary:x-taxonomy> <http://bio2rdf.org/taxonomy:9606> . } limit "
										+ context.limit, "UTF-8")
						...
						if (out1 != null) {
							...
							for (String[] item_tRunJob_1 : childReturn_tRunJob_1) {
								...
								String searchStr_tReplace_1_7 = "bio2rdf_vocabulary:"
										+ "";
								row4.rdf = StringUtils.replaceAllStrictly(
										row4.rdf, searchStr_tReplace_1_7, "bm_"
												+ "", false, false);
								String searchStr_tReplace_1_8 = "_vocabulary:"
										+ "";
								row4.rdf = StringUtils.replaceAllStrictly(
										row4.rdf, searchStr_tReplace_1_8, "_"
												+ "", false, false);
								...
								if (out5 != null) {
									...
									if (row10.ERROR_CODE != null) { //

										strBuffer_tLogRow_10.append(String
												.valueOf(row10.ERROR_CODE));
									...
									// ////
									// ////
									globalMap.put("tLogRow_10_NB_LINE",
											nb_line_tLogRow_10);
	...
	public static void main(String[] args) {
		final describe_goa_2_jsonld describe_goa_2_jsonldClass = new describe_goa_2_jsonld();

		int exitCode = describe_goa_2_jsonldClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = describe_goa_2_jsonld.class
					.getClassLoader().getResourceAsStream(
							"bio2rdf/describe_goa_2_jsonld_0_1/contexts/"
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : describe_goa_2_jsonld");
		}
...
/************************************************************************************************
 * 162647 characters generated by Talend Open Studio for Data Integration on the
