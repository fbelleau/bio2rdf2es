...
/**
 * Job: JOBS_omim Purpose: <br>
 * Description:  <br>
 * @author test@talend.com
 * @version 5.6.0.20141024_1545
 * @status 
 */
public class JOBS_omim implements TalendJob {
	...
	private final String jobName = "JOBS_omim";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(JOBS_omim.this, new Object[] { e,
	...
	public static class row2Struct implements
		...
		final static byte[] commonByteArrayLock_BIO2RDF_JOBS_omim = new byte[0];
		static byte[] commonByteArray_BIO2RDF_JOBS_omim = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_BIO2RDF_JOBS_omim.length) {
					if (length < 1024
							&& commonByteArray_BIO2RDF_JOBS_omim.length == 0) {
						commonByteArray_BIO2RDF_JOBS_omim = new byte[1024];
					} else {
						commonByteArray_BIO2RDF_JOBS_omim = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_BIO2RDF_JOBS_omim, 0, length);
				strReturn = new String(commonByteArray_BIO2RDF_JOBS_omim, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_BIO2RDF_JOBS_omim) {
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				result_tFixedFlowInput_1
						.append("aHR0cDovL2JpbzJyZGYub3JnL29taW1fdm9jYWJ1bGFyeTpFbnRpdHkKaHR0cDovL2JpbzJyZGYu");
				result_tFixedFlowInput_1
						.append("b3JnL29taW1fdm9jYWJ1bGFyeTpDbGluaWNhbC1TeW5vcHNpcwpodHRwOi8vYmlvMnJkZi5vcmcv");
				result_tFixedFlowInput_1
						.append("b21pbV92b2NhYnVsYXJ5OkdlbmUKaHR0cDovL2JpbzJyZGYub3JnL29taW1fdm9jYWJ1bGFyeTpQ");
				result_tFixedFlowInput_1
						.append("cmVkb21pbmFudGx5LXBoZW5vdHlwZXMKaHR0cDovL2JpbzJyZGYub3JnL29taW1fdm9jYWJ1bGFy");
				result_tFixedFlowInput_1
						.append("eTpBbGxlbGljLVZhcmlhbnQKaHR0cDovL2JpbzJyZGYub3JnL29taW1fdm9jYWJ1bGFyeTpDaGFy");
				result_tFixedFlowInput_1
						.append("YWN0ZXJpc3RpYwpodHRwOi8vYmlvMnJkZi5vcmcvb21pbV92b2NhYnVsYXJ5OkdlbmUtcGhlbm90");
				result_tFixedFlowInput_1
						.append("eXBlCmh0dHA6Ly9iaW8ycmRmLm9yZy9vbWltX3ZvY2FidWxhcnk6UGhlbm90eXBlCmh0dHA6Ly9i");
				result_tFixedFlowInput_1
						.append("aW8ycmRmLm9yZy9vbWltX3ZvY2FidWxhcnk6UGhlbm90eXBlLU1hcA==");
	...
	public static void main(String[] args) {
		final JOBS_omim JOBS_omimClass = new JOBS_omim();

		int exitCode = JOBS_omimClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = JOBS_omim.class.getClassLoader()
					.getResourceAsStream(
							"bio2rdf/jobs_omim_0_1/contexts/" + contextStr
									+ ".properties");
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : JOBS_omim");
		}
...
/************************************************************************************************
 * 47583 characters generated by Talend Open Studio for Data Integration on the
