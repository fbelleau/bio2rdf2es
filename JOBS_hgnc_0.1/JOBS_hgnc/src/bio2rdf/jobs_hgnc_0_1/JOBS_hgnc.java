...
/**
 * Job: JOBS_hgnc Purpose: <br>
 * Description:  <br>
 * @author test@talend.com
 * @version 5.6.0.20141024_1545
 * @status 
 */
public class JOBS_hgnc implements TalendJob {
	...
	private final String jobName = "JOBS_hgnc";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(JOBS_hgnc.this, new Object[] { e,
				...
				for (int i_tFixedFlowInput_1 = 0; i_tFixedFlowInput_1 < 1; i_tFixedFlowInput_1++) {
					...
					while (fid_tFixedFlowInput_1.nextRecord()) {
						...
						if (1 < fid_tFixedFlowInput_1
							...
							row1.index = (colContent == null || colContent
									.length() == 0) ? null : colContent;
						} else {
						...
						if (row1.index != null) { //
							row_tLogRow_1[1] = String.valueOf(row1.index);
	...
	public static void main(String[] args) {
		final JOBS_hgnc JOBS_hgncClass = new JOBS_hgnc();

		int exitCode = JOBS_hgncClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = JOBS_hgnc.class.getClassLoader()
					.getResourceAsStream(
							"bio2rdf/jobs_hgnc_0_1/contexts/" + contextStr
									+ ".properties");
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : JOBS_hgnc");
		}
