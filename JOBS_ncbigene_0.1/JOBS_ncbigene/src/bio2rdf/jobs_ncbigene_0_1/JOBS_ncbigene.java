...
package bio2rdf.jobs_ncbigene_0_1;
...
/**
 * Job: JOBS_ncbigene Purpose: <br>
 * Description:  <br>
 * @author test@talend.com
 * @version 5.6.0.20141024_1545
 * @status 
 */
public class JOBS_ncbigene implements TalendJob {
	...
	private final String jobName = "JOBS_ncbigene";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					JOBS_ncbigene.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(JOBS_ncbigene.this, new Object[] { e,
	...
	public static class row2Struct implements
		...
		final static byte[] commonByteArrayLock_BIO2RDF_JOBS_ncbigene = new byte[0];
		static byte[] commonByteArray_BIO2RDF_JOBS_ncbigene = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_BIO2RDF_JOBS_ncbigene.length) {
					if (length < 1024
							&& commonByteArray_BIO2RDF_JOBS_ncbigene.length == 0) {
						commonByteArray_BIO2RDF_JOBS_ncbigene = new byte[1024];
					} else {
						commonByteArray_BIO2RDF_JOBS_ncbigene = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_BIO2RDF_JOBS_ncbigene, 0, length);
				strReturn = new String(commonByteArray_BIO2RDF_JOBS_ncbigene,
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_BIO2RDF_JOBS_ncbigene) {
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				result_tFixedFlowInput_1
						.append("aHR0cDovL2JpbzJyZGYub3JnL25jYmlnZW5lX3ZvY2FidWxhcnk6R2VuZQ==");
				...
				for (int i_tFixedFlowInput_1 = 0; i_tFixedFlowInput_1 < 1; i_tFixedFlowInput_1++) {
					...
					while (fid_tFixedFlowInput_1.nextRecord()) {
						...
						paraList_tRunJob_1.add("--context_param namespace="
								+ RuntimeUtils
										.tRunJobConvertContext(obj_tRunJob_1));
						parentContextMap_tRunJob_1.put("namespace",
								obj_tRunJob_1);

						obj_tRunJob_1 = context.debug;
						paraList_tRunJob_1.add("--context_param debug="
								+ RuntimeUtils
										.tRunJobConvertContext(obj_tRunJob_1));
						parentContextMap_tRunJob_1.put("debug", obj_tRunJob_1);

						obj_tRunJob_1 = context.limit;
						paraList_tRunJob_1.add("--context_param limit="
								+ RuntimeUtils
										.tRunJobConvertContext(obj_tRunJob_1));
						parentContextMap_tRunJob_1.put("limit", obj_tRunJob_1);

						obj_tRunJob_1 = row1.type;
						paraList_tRunJob_1.add("--context_param type="
								+ RuntimeUtils
										.tRunJobConvertContext(obj_tRunJob_1));
						parentContextMap_tRunJob_1.put("type", obj_tRunJob_1);

						bio2rdf.describe_ncbigene_2_jsonld_0_1.describe_ncbigene_2_jsonld childJob_tRunJob_1 = new bio2rdf.describe_ncbigene_2_jsonld_0_1.describe_ncbigene_2_jsonld();
						// pass DataSources
	...
	public static void main(String[] args) {
		final JOBS_ncbigene JOBS_ncbigeneClass = new JOBS_ncbigene();

		int exitCode = JOBS_ncbigeneClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = JOBS_ncbigene.class
					.getClassLoader().getResourceAsStream(
							"bio2rdf/jobs_ncbigene_0_1/contexts/" + contextStr
									+ ".properties");
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : JOBS_ncbigene");
		}
...
/************************************************************************************************
 * 45247 characters generated by Talend Open Studio for Data Integration on the
 * July 14, 2016 7:15:54 EDT AM
 ************************************************************************************************/
